...
public partial class App : Application
{
    ...
    protected override async void OnStartup(StartupEventArgs e)
    {
        ...
        try
        {
            ...
            var printAttemptStore = new JsonPrintAttemptStore(Path.Combine(localData, "print-attempts.json"));
            ...
            var viewModel = new MainViewModel(
                receiptService, imageService, settingsService, authentication,
                printService, printAttemptStore, dialogs, _logger);
